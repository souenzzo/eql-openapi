(ns br.com.souenzzo.ring-http-client
  ...
  (:import (java.io ByteArrayOutputStream)
           (java.net URI)
           (java.net.http HttpClient HttpClient$Version HttpHeaders HttpRequest HttpRequest$BodyPublishers HttpResponse HttpResponse$BodyHandler HttpResponse$BodyHandlers HttpResponse$BodySubscriber HttpResponse$ResponseInfo)
           (java.nio ByteBuffer)
           (java.util Optional)
...
(defn ^HttpResponse ring-response->http-response
  ...
  (let [baos (ByteArrayOutputStream.)
        ...
        *body (delay
                (with-open [os (io/output-stream baos)]
                  (rcp/write-body-to-stream body ring-response os))
...
(extend-protocol RingHttpClient
  HttpClient
  (send [this ring-request]
    (-> this
